...
function $$SETUP_STATE(hydrateRuntimeState, basePath) {
  return hydrateRuntimeState({
    ...
    "dependencyTreeRoots": [
      ...
      {
        "name": "@tsw/foobar",
        "reference": "workspace:packages/foobar"
      },
      {
        "name": "@tsw/logger",
    ...
    "fallbackExclusionList": [
      ["@tsw/common", ["workspace:packages/common"]],
      ["@tsw/foobar", ["workspace:packages/foobar"]],
      ["@tsw/logger", ["workspace:packages/logger"]],
    ...
    "packageRegistryData": [
      ...
      ["@tsw/foobar", [
        ["workspace:packages/foobar", {
          "packageLocation": "./packages/foobar/",
          "packageDependencies": [
            ["@tsw/foobar", "workspace:packages/foobar"],
            ["@tsw/common", "workspace:packages/common"],
            ["@tsw/logger", "workspace:packages/logger"],
